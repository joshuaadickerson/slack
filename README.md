...
[![Build Status](https://travis-ci.org/joshuaadickerson/slack.svg?branch=master)](https://travis-ci.org/joshuaadickerson/slack)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/joshuaadickerson/slack/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/joshuaadickerson/slack/?branch=master)
...
* Laravel integration: [Slack for Laravel](https://github.com/joshuaadickerson/slack-laravel)
...
```sh
composer require joshuaadickerson/slack
```
...
$client = new JoshuaADickerson\Slack\Client('https://hooks.slack.com/...');
...
$client = new JoshuaADickerson\Slack\Client('https://hooks.slack.com/...', $settings);
```
