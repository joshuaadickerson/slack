...
use JoshuaADickerson\Slack\Client;
...
class ClientUnitTest extends PHPUnit_Framework_TestCase
{
    public function testInstantiationWithNoDefaults()
    {
        ...
        $this->assertInstanceOf('JoshuaADickerson\Slack\Client', $client);
    ...
    public function testCreateMessage()
    {
        ...
        $this->assertInstanceOf('JoshuaADickerson\Slack\Message', $message);
